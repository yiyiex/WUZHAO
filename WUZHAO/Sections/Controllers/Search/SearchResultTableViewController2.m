...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"UserListTableViewCellWithFollowButton" forIndexPath:indexPath];
    ...
    if (self.searchUserListData.count == 0 && indexPath.row ==0)
    {
        ...
        if (self.searchStatus == SEARCHSTATUSING)
        {
            UITableViewCell *cell = [[UITableViewCell alloc]init];
