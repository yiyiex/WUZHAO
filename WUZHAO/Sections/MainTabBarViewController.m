...
@property (nonatomic, strong) HomeContainerViewController *homeViewController;
...
-(void)initViewControllers
{
    ...
    //***change
    UIStoryboard *homeStoryboard = [UIStoryboard storyboardWithName:@"WhatsNew" bundle:nil];
    self.homeViewController = [homeStoryboard instantiateViewControllerWithIdentifier:@"HomeContainer"];
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(UIViewController *)viewController
{
    ...
    if (self.currentTabIndex == WZ_HOME_TAB)
    {
       ...
       // [self.homeViewController setTableStyle:WZ_TABLEVIEWSTYLE_HOME];
        [self.homeViewController getLatestData];
    }
