...
#pragma mark- _FilterEditorViewController

@interface FilterEditorViewController()
<CLImageToolProtocol>
...
@implementation FilterEditorViewController
{
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        //self.toolInfo = [CLImageToolInfo toolInfoForToolClass:];
