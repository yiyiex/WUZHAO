...
//#import "FilterEditorViewController.h"
...
- (id)init
{
    ...
    //return [FilterEditorViewController new];
}
...
{
    //return [[FilterEditorViewController alloc] initWithImage:image delegate:delegate];
    return [[_CLImageEditorViewController alloc] initWithImage:image delegate:delegate];
}

- (id)initWithDelegate:(id<CLImageEditorDelegate>)delegate
{
    //return [[FilterEditorViewController alloc] initWithDelegate:delegate];
