...
{
    _dropDownItems = [[NSMutableArray alloc] initWithArray:dropDownItems copyItems:YES];
}
...
- (void)resetParams
{
    ...
    self.style = IGLDropDownMenuStyleWhite;
...
-(void)setStyleOfMenuItem:(IGLDropDownItem *)item
{
    if (self.style == IGLDropDownMenuStyleBlack)
    {
        [item setBackgroundColor:[UIColor blackColor]];
        [item setShadowColor:[UIColor darkGrayColor]];
        [item setTextColor:[UIColor whiteColor]];        
    }
    else if (self.style == IGLDropDownMenuStyleWhite)
    {
        [item setBackgroundColor:[UIColor whiteColor]];
        [item setShadowColor:[UIColor grayColor]];
        [item setTextColor:[UIColor grayColor]];
    }
}
...
-(void)addMenuItemWithTitle:(NSString *)title icon:(UIImage *)icon
{
